                ...
                <View
                  ...
                  {connectedId === device.id && isConnected ? (
                    <Image
                      ...
                      source={require('./images/BluetoothIcon.png')}
                    />
                  ) : null}
                </View>
              ) : null}
...
const App = () => {
  ...
  const activeTabStyle = {borderBottomWidth: 6, borderColor: '#fff', borderRadius:3};
  return (
    <View style={{flex: 1}}>
        ...
        {Platform.OS === 'android' ? (
          <View style={styles.enableInfoWrapper}>
            ...
            <Switch onValueChange={toggleBluetooth} value={state.isEnabled}
              ...
              thumbColor={state.isEnabled ? '#f4f3f4' : '#f4f3f4'}
             />
          </View>
        ) : null}
      </View>
